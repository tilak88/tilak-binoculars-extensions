...
The source presentation reports a balanced 5,422-sample evaluation across CNN-Falcon, CNN-Llama, PubMed, and HC3 using a 256-token cap and a single joint observer/performer pass.

| Feature | Average/result reported | Interpretation |
|---|---:|---|
| Binoculars baseline | AUROC 0.966 average | Strongest standalone reference |
